...
public class OrderApplicationService {
    ...
    public String createOrder(OrderReqDto orderReqDto) {
        ...
        Map<Integer, Long> productIdToQuantity =
                orderReqDto.getOrderProducts().stream()
                        .collect(Collectors.toMap(OrderProductReqDto::getProductId, OrderProductReqDto::getQuantity));
    ...
    private static List<ProductDetail> getProductDetails(List<Product> products, Map<Integer, Long> productIdToQuantity) {
